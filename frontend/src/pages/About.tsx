...
const About = () => {
  return (
    ...
    <p className="text-lg text-gray-700 mb-6">
      ...
      excellence. We believe in fostering a culture of creativity and collaboration.
    </p>
    <h2 className="text-2xl font-semibold mb-2">Contact Us</h2>
    <p className="text-lg text-gray-700">
      If you have any questions or want to know more about us, feel free to reach out.
      Email us at <a href="mailto:info@example.com" className="text-blue-500 hover:underline">info@example.com</a>.
    </p>
  </div>
  )
}
